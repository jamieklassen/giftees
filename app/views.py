...
class Wishlist(djviews.View):
    ...
    def get(self, request, **kwargs):
        ...
        if profile_id is None:
            qs = models.Gift.objects.filter(wisher=request.user)
        else:
...
class Giftees(djviews.View):
    ...
    def post(self, request, **kwargs):
        ...
        this.buying_for.add(djmodels.User.objects.get(id=profile_id))
        this.save()
...
class Shopping(djviews.View):
    ...
    def get(self, request, **kwargs):
        ...
        gift_id = kwargs.get('id')
        if gift_id is None:
            qs = models.Gift.objects.filter(buyer=request.user)
        else:
